            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;">
                        <!--      <img src="images/logo.jpg"  width="15% "/> -->ONLINE MOBILE STOREx        </h4></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right wow fadeInDown">
                    <ul class="nav navbar-nav">
                        ...
                        <li ><a href="available.php"> Products</a></li>
...
<div class="container">
        <section id="contact-info">
            ...
            <div class="left wow fadeInDown">
                <hr>
               <div class="col-md-6">
                <img src="images/22.jpg" class="img-responsive pull-right" />
               </div> 
               <div class="col-md-6">
                <p class="lead">
                    <br>
                    <p><span style="font-size:20px; font-weight:bold; font-family:verdana; color:red;">OPPO BRANCH</span>
                    <br><b>Address:</b> Gaisano,Kabankalan City <b><br>Tel No:</b> 0944-2345<b><br>Phone No:</b> +6309344977<b></p>
                    <hr>
